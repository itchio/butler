...
func Register(router *butlerd.Router) {
	...
	messages.LaunchGetCandidates.Register(router, LaunchGetCandidates)
}

func LaunchGetCandidates(rc *butlerd.RequestContext, params butlerd.LaunchGetCandidatesParams) (*butlerd.LaunchGetCandidatesResult, error) {
