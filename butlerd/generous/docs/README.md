...
### Fetch.ScrapedScreenshots (client request)


<p>
<p>A bad endpoint you probably shouldn&rsquo;t rely on, if I&rsquo;m quite honest.
Please don&rsquo;t use it?</p>
...
<td><code>gameId</code></td>
<td><code class="typename"><span class="type builtin-type">number</span></code></td>
<td><p>The game for which to grab screenshots</p>
</td>
</tr>
</table>
...
<td><code class="typename"><span class="type builtin-type">string</span>[]</code></td>
<td><p>The returned screenshots</p>
</td>
</tr>
</table>


<div id="FetchScrapedScreenshotsParams__TypeHint" class="tip-content">
<p>Fetch.ScrapedScreenshots (client request) <a href="#/?id=fetchscrapedscreenshots-client-request">(Go to definition)</a></p>
...
<div id="FetchScrapedScreenshotsResult__TypeHint" class="tip-content">
<p>FetchScrapedScreenshots  <a href="#/?id=fetchscrapedscreenshots-">(Go to definition)</a></p>
